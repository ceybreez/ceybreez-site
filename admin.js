...
function showCmsForm(id){ document.getElementById(id)?.classList.remove("hidden"); setTimeout(()=>document.getElementById(id)?.scrollIntoView({behavior:"smooth",block:"start"}),80); }
...
function openInquiryModal(id){
  ...
  <button class="delete-btn" onclick="deleteCurrentInquiry()">Delete Inquiry</button>
    ...
    <div class="modal-section booking-confirm-panel">
      <h4>Booking Confirmation Details</h4>
      ...
      <p class="confirm-help">
        Total nights and total amount calculate automatically from check-in/check-out dates and day rate.
      </p>
    </div>
  ...
  document.getElementById("bookingConfirmDayRate")?.addEventListener("input", updateBookingConfirmTotals);
