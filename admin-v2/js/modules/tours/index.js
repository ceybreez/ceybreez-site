...
async function handleTourSubmit(e) {
  ...
  if (!title) return alert("Tour title is required");
...
function wireToursModule() {
  ...
  document.getElementById("tourPackageCloseBtn")?.addEventListener("click", () => document.getElementById("tourPackageFormBox")?.classList.add("hidden"));
