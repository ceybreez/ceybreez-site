...
export function renderToursModuleShell(container) {
  if (!container) return;
  if (container.dataset.toursModuleRendered === "1") return;
  ...
  container.innerHTML = `
    <div class="tours-module">
      <div class="tours-module-head">
        <div>
          <h2>Tours CMS</h2>
          <p>Manage tour destinations and sellable tour packages from one place.</p>
        </div>
      </div>
        ...
        <section class="tour-packages-box">
          ...
          <div class="table-wrap cms-table-wrap tours-table-wrap">
            <table class="admin-table cms-table tours-table">
              <thead>
                <tr>
                  <th>Tour</th><th>Category</th><th>Destination</th><th>Duration</th>
                  <th>Price</th><th>Status</th><th>Featured</th><th>Action</th>
                </tr>
              </thead>
            ...
            <div class="tour-modal-card">
              <div class="tour-modal-head">
                <div>
                  ...
                  <p>Complete the tabs and save. This will create a record in D1 tour_packages.</p>
                </div>
              ...
              <form id="tourPackageForm" class="tour-package-form">
                ...
                <div class="tour-modal-body">
                  <div class="tour-form-pane active" data-tour-form-pane="basic">
                    <div class="tour-pane-title"><h4>Basic Information</h4><p>Tour identity, destination and duration.</p></div>
                  ...
                  <div class="tour-form-pane" data-tour-form-pane="pricing">
                    <div class="tour-pane-title"><h4>Pricing</h4><p>Set adult/base price, child price and currency.</p></div>
                  ...
                  <div class="tour-form-pane" data-tour-form-pane="content">
                    <div class="tour-pane-title"><h4>Description, Itinerary & Includes</h4><p>Add full details for the public tour page.</p></div>
                  ...
                  <div class="tour-form-pane" data-tour-form-pane="gallery">
                    <div class="tour-pane-title"><h4>Images & Gallery</h4><p>Upload images directly or paste image URLs.</p></div>

                    <div class="tour-upload-grid">
                      <section class="tour-upload-card">
                        <div class="tour-upload-card-head">
                          <div><h5>Main Image</h5><p>Used on the tour card and tour details cover.</p></div>
                          <span id="tourMainImageStatus" class="tour-upload-status"></span>
                        </div>
                        <div id="tourMainImagePreview" class="tour-main-image-preview">No main image selected</div>
                        <div class="tour-upload-actions">
                          <input id="tourMainImageFile" type="file" accept="image/*" hidden />
                          <button type="button" id="tourMainImageUploadBtn" class="tour-upload-btn">Upload Main Image</button>
                          <button type="button" id="tourMainImageRemoveBtn" class="tour-remove-btn">Remove</button>
                        </div>
                      ...
                      <section class="tour-upload-card">
                        <div class="tour-upload-card-head">
                          <div><h5>Gallery Images</h5><p>Select multiple images at once.</p></div>
                          <span id="tourGalleryStatus" class="tour-upload-status"></span>
                        </div>
                        <div class="tour-upload-actions">
                          <input id="tourGalleryFiles" type="file" accept="image/*" multiple hidden />
                          <button type="button" id="tourGalleryUploadBtn" class="tour-upload-btn">Upload Gallery Photos</button>
                          <button type="button" id="tourGalleryClearBtn" class="tour-remove-btn">Clear Gallery</button>
                        </div>
                  ...
                  <div class="tour-form-pane" data-tour-form-pane="settings">
                    <div class="tour-pane-title"><h4>Booking Rules & Status</h4><p>Control website visibility.</p></div>
                ...
                <div class="tour-modal-footer">
                  ...
                  <button type="submit" id="tourPackageSaveBtn" class="tour-primary-btn">Save Tour Package</button>
                </div>
              </form>
            </div>
          </div>
...
export function renderTourPackagesTable(tours = []) {
  ...
  const filtered = tours.filter(t => {
    ...
    const active = t.active === true || Number(t.active) === 1;
    const featured = t.featured === true || Number(t.featured) === 1;
  ...
  tbody.innerHTML = filtered.map(t => {
    ...
    const featured = t.featured === true || Number(t.featured) === 1;
    return `
      <tr class="clickable-row" data-tour-row="${escapeHtml(t.id)}">
