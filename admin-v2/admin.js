...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (ADMIN_TOKEN) {
    ...
    loadAll();
    setTimeout(() => showTab("dashboardTab"), 100);
  }
...
function showTab(tab) {
  const allTabsV61 = ["dashboardTab","destinationsTab","propertiesTab","servicesTab","inquiriesTab","bookingsTab","reviewsTab","reportsTab","pageControlTab","settingsTab"];
  allTabsV61.forEach(id => document.getElementById(id)?.classList.add("hidden"));
  const mapV61 = { dashboard:"dashboardTab", dashboardTab:"dashboardTab", destinations:"destinationsTab", properties:"propertiesTab", services:"servicesTab", inquiriesTab:"inquiriesTab", bookingsTab:"bookingsTab", reviewsTab:"reviewsTab", reportsTab:"reportsTab", pageControl:"pageControlTab", settingsTab:"settingsTab" };
